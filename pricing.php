		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2>QUEM SOMOS</h2>
					<p style="text-align: justify; text-indent: 25px; color: #000;">
					Fundada em 2018 pelos acadêmicos da Faculdade Meta, Cleyton Amanajas, Lidiane Neves e Orcicley Junior. A equipe EntregaFácil é uma empresa focada em um serviço otimizado de entrega de diversos produtos, tendo como diferencial a facilidade de funcionamento da logística.
					Formada por gestores empresarias com conhecimento no ramo e funcionários (motoboys) que realizam as entregas com rapidez e em qualquer hora. Tudo isso acontece quando através de nosso site, aplicativo próprio ou WhatsApp, somos contratados para prestar um serviço de entrega de produtos 
 					</p>
				</div>
			</div>
			</div>
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
					<h2>MISSÃO</h2>
					<p style="text-align: justify; text-indent: 25px; color: #000;">Um serviço seguro, rápido e fácil, que visa melhorar a vida das pessoas que em um caso de emergência, falta de tempo ou até mesmo logística, precisam de algum produto ou encomenda específica. Sem dificuldade nós resolvemos o problema para você.</p>
				</div>
			</div>
			</div>
			</div>
